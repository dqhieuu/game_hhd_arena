set INPUT= .\src\SoundEffect.cpp .\src\SoundEffectPlayer.cpp .\src\MusicPlayer.cpp .\src\Renderer.cpp .\src\Locator.cpp .\src\Timer.cpp .\src\Texture.cpp .\src\Sprite.cpp .\src\Character.cpp .\src\Game.cpp .\src\Stage1.cpp .\src\main.cpp
...
set LIB_DIR=-L .\libs\SDL2-2.0.12\i686-w64-mingw32\lib -L .\libs\SDL2_image-2.0.5\i686-w64-mingw32\lib  -L .\libs\SDL2_mixer-2.0.4\i686-w64-mingw32\lib -L .\libs\SDL2_ttf-2.0.15\i686-w64-mingw32\lib
